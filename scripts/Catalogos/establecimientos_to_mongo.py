"""
establecimientos_to_mongo.py
Carga el archivo 'GOBI Salud Establecimiento de Salud 2026.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: establecimientos-salud)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Establecimiento de Salud 2026.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "catalogo-establecimientos")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
