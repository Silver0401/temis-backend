"""
rev_to_mongo.py
Carga el archivo 'GOBI Salud Rev 2021.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: rev-catalog)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Rev 2021.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "catalogo-paises")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
