"""
localidades_to_mongo.py
Carga el archivo 'GOBI Salud Localidades 2026.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: localidades)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Localidades 2026.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "catalogo-localidades")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
