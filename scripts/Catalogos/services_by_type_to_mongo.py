"""
services_by_type_to_mongo.py
Carga el archivo 'GOBI Salud Services by Type.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: services-by-type)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Services by Type.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "catalogo-serv-by-type")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
