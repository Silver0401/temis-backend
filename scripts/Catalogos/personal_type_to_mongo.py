"""
personal_info_to_mongo.py
Carga el archivo 'GOBI Salud Personal Info 2024.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: personal-info)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Personal Info 2024.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "catalogo-personal-type")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
