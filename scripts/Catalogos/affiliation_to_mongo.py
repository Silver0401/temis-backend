"""
affiliation_to_mongo.py
Carga el archivo 'GOBI Salud Affiliation 2024.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: affiliations)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Affiliation 2024.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "catalogo-afiliaciones")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
