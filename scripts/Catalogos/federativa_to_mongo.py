"""
federativa_to_mongo.py
Carga el archivo 'GOBI Salud Federativa 2016.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: federativa-catalog)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Federativa 2016.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "catalogo-ent-fed")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
