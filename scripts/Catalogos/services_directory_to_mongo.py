"""
services_directory_to_mongo.py
Carga el archivo 'GOBI Salud Services Directory Sept 2025.xlsx' desde Downloads
...
Variables del .env:
  ...
  NOT_COLLECTION    — colección      (default: services-directory)
"""
...
EXCEL_PATH  = os.path.join(CATALOG_DIR, "GOBI Salud Services Directory Sept 2025.xlsx")
MONGO_URI   = os.environ.get("NOT_MONGODB_URL", "")
DB_NAME     = os.environ.get("NOT_DB_NAME", "test")
COLLECTION  = os.environ.get("NOT_COLLECTION", "services-directory")
BATCH_SIZE  = 500
# ─────────────────────────────────────────────────────────────────────────────
