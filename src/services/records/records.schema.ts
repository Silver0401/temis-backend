...
const DiagnosticoCatalogoSchema = Type.Object(
  {
    ...
    CLAVE_PROGRAMA_SIS: Type.Optional(Type.Union([Type.String(), Type.Number()])),
    CLAVE_CAPITULO: Type.Optional(Type.String()),
    CAPITULO: Type.Optional(Type.String()),
    ES_SUIVE_MORB: Type.Optional(Type.String()),
    EPI_CLAVE: Type.Optional(Type.Union([Type.String(), Type.Number()])),
    'EPI_CLAVE_DESC 2024': Type.Optional(Type.String()),
    TIPO_PERSONAL_1VEZ_CE: Type.Optional(Type.Union([Type.String(), Type.Number()])),
    TIPO_PERSONAL_SUBSEC_CE: Type.Optional(Type.Union([Type.String(), Type.Number()])),
    VALIDO_SM: Type.Optional(Type.String()),
    VALIDO_SB: Type.Optional(Type.Union([Type.String(), Type.Number()])),
