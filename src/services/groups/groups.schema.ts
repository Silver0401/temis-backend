...
export const groupsSchema = Type.Object(
  {
    _id: ObjectIdSchema(),
    name: Type.String(),
    patients: Type.Array(ObjectIdSchema()),
    members: Type.Array(ObjectIdSchema())
  },
...
export const groupsQueryProperties = Type.Pick(groupsSchema, ['_id', 'name', 'patients', 'members'])
export const groupsQuerySchema = Type.Intersect(
  [
    querySyntax(groupsQueryProperties),
    // Add additional query properties here
    Type.Object(
      { populatePatients: Type.Optional(Type.Boolean()), getUserGroups: Type.Optional(Type.Boolean()) },
